...
* Organização de código em camadas (Main / Service)
* Boas práticas iniciais de validação
...
Este projeto foi criado com o objetivo de consolidar fundamentos essenciais da programação, evoluindo gradualmente para soluções mais próximas de sistemas reais.
...
3. Execute a classe `SistemaMain`
